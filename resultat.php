...
<br>
<br>
<img src='images/logo-comfordev.png' width='500'>

<?php
if ($choix == "FACTURE") {
    ?>
    <h2 align="center"> Facture n° <?php echo $id; ?></h2>
    <?php
} else {
    ?>
...
<div align="center">
    <table style="margin-top:90px ;">
        <tr>
            <th width='300'> Nom de produit</th>
            <th width='200'> Prix unitaire</th>
            <th width='200'> Quantit&eacute;</th>
            <th width='200'> Prix Totale</th>
        </tr>
        <?php
    ...
    <table style="margin-left:300px">
        <tr>
            <td width='400'></td>
            <td><b>TOTAL HTVA:<?php echo $donnees4['totale']; ?>&nbsp;FCFA </b></td>
        </tr>
        <tr>
            <td width='400'></td>
            <td><b>TVA: 10%</b></td>
        ...
        <tr>
            <td width='400'></td>
            <td><b>Total T.T.C: <?php echo $donnees4['totale_tva']; ?>&nbsp;FCFA</b></td>
        </tr>
    </table>
</div>
